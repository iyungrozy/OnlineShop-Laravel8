	...
	<div class="row pt-5">
		<div class="col-md-8">
			<div class="intro text-white">
				<h2><b><u>Halaman Masuk Pelanggan A&A Stores .</u></b></h2>
				<b>Silahkan Masuk untuk melanjutkan dan melakukan pemesanan produk</b>
			</div>
		</div>
            ...
            <div class="card-body">
              <form class="form-auth-small" method="POST" action="{{ route('login') }}">
					...
					<div class="bottom">
						...
						<span class="helper-text"><i class="oi oi-lock"></i> <a class="text-primary-darker" href="{{ route('register') }}"><u>Daftar Sebagai Pelaggan</u></a></span>
					</div>
					@endif
				</form>
            </div>
