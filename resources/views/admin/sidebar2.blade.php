...
<div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav">
    ...
    <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
      ...
      <li><a href="{{ route('admin.masakan') }}"><span class="oi oi-puzzle-piece"></span></span> Daftar Produk</a></li>
      ...
      <div class="pt-4">
          <a href="#" class="pl-3 fs-smallest fw-bold text-muted">Kasir</a> 
          <ul class="list-unstyled">
          <li><a href="{{route('entri.order')}}"><span class="oi oi-clipboard"></span> Diantar<span class="badge badge-warning float-right">{{$entri->count()}}</span></a></li>
          <li><a href="{{route('cashier')}}"><span class="oi oi-bell bell"></span> Kasir <span class="badge badge-warning float-right">{{$cashier->count()}}</span></a></li>        
          </ul>
      </div>
      @endif
