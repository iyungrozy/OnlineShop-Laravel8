					...
					<table class="table">
					  ...
					  <tbody>
					    ...
					    <tr>
					      ...
					      <td>
					      	<img src="{{url('storage/app/public/gambar/'.$dt['item']['gambar'])}}" alt="Gambar Produk" class="img-thumnail" width="50px">
					      </td>
	...
	@else
		<div class="row">
			<div class="col pt-5 mx-auto">
				...
				<br>
				<a href="{{route('menu-masakan')}}" class="btn btn-success">Ke Menu Produk</a>
			</div>
		</div>
	@endif
