...
<style>
    ...
    height: 280px; /* Tetapkan tinggi tetap yang diinginkan */
    object-fit: cover;
}
	}
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption">
	   ...
	   <!-- <button type="button" class="btn btn-success" data-tx`oggle="modal" data-target=".bd-example-modal-lg">Petunjuk Order</button> -->
	  </div>
    </div>
  </div>
</div>
	...
	<div class="row">
		...
		<div class="col-md-4 pb-4">
			<div class="card-group">
			  ...
			  <a href="{{ route('product.detail', ['id' => $dt->id]) }}"> <!-- Tautan ke halaman detail produk -->
			        <img class="card-img-top" src="{{ url('storage/app/public/gambar/'.$dt->gambar) }}" style="width: 100%; height: 280px;">
			    </a>
			    <div class="card-body">
			      <small>{{$dt->kode_masakan}} | {{$dt->nama_kategori}}</small>	
			      <h5 class="card-title">
			        <a href="{{ route('product.detail', ['id' => $dt->id]) }}">{{ $dt->nama_masakan }}</a> <!-- Tautan ke halaman detail produk -->
			      </h5>
			      <p>
			      	<?php 
			    ...
			    <div class="card-footer">
									@if($dt['status_masakan']=='Ada')
						@if(Auth::check())
							<!-- Tampilkan tombol pesan jika pengguna sudah login -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="guide">
			...
			<p>5. Menu Produk dengan tombol yang bila anda tekan akan langsung masuk kedalam keranjang anda, <b>Untuk tombol dengan stok habis tidak bisa dipesan karena stok menunya sedang tidak tersedia</b> .</p>
		</div>
		<hr>
		<div class="guide">
		...
		<div class="guide">
			...
			<p><span class='badge badge-success'>Beres</span> = pesanan telah beres dan menu sudah sampai di meja anda.</p>
