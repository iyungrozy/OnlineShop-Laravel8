...
Route::group(['prefix' => 'produk'], function() {
	...
	Route::get('/product/{id}', 'FrontEndController@showProduct')->name('product.detail');
...
Route::group(['prefix'=>'admin','middleware'=>['auth']], function() {
	...
	// Masakan Route
	Route::group(['prefix'=>'produk','middleware'=>'level.admin'], function()
	{
	...
	//Entri Order rOUTE
	Route::group(['prefix'=>'entri','middleware'=>'level.admin:kasir:waiter'], function()
	{
	...
	Route::group(['prefix'=>'transaksi','middleware'=>'level.admin:kasir'], function()
	{
		...
		Route::get('/input', 'TransaksiController@create')->name('admin.transaksi.create');
		Route::post('/input', 'TransaksiController@store')->name('admin.transaksi.store');
		Route::get('/selesai/{id}', 'TransaksiController@finish')->name('admin.transaksi.finish');
	});
	// End Transaksi
