...
@section('content')
	...
	<div class="row pl-3 pt-2 mb-5">
	    <div class="col-lg-12 pl-3">
	    	<h1>Data Semua Produk</h1>

			<div class="row">
				<div class="col-md-6 mb-3">
					<a href="" data-toggle="modal" data-target="#tambahProduk" class="btn btn-primary"><span class="oi oi-plus"></span> Buat Baru</a>
				</div>
		        ...
		        <table id="datatabled" class="table">
		            ...
		            <tbody>
		              ...
		              <tr>
					      ...
					      <td><a href="{{url('storage/app/public/gambar/'.$dt->gambar)}}"><img class="img-fluid" src="{{url('storage/app/public/gambar/'.$dt->gambar)}}" width="75px"></a></td>
					      <td>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					<h3 class="modal-title text-white">Tambah Data Produk</h3>
					<button class="close" type="button" data-dismiss="modal">
						<span class="text-white">x</span>
					</button>
				</div>
